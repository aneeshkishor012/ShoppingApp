...
import { Row, Col, Typography, Button, Rate, Tag, Divider, InputNumber, Carousel } from 'antd';
...
const ProductDetailsClient: React.FC = () => {
    ...
    const discountedPrice = product.discountDetails ? product.price * (1 - product.discountDetails / 100) : product.price;
